...
export default function EditCustomerPage({
    ...
    // Unwrap params with React.use() instead of direct access
                ...
                >
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                                    required
                                />
                            </div>
                        ...
                        <div className="pt-5">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                Update customer's detailed address information.
                            </p>
                        </div>
